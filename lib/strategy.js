...
function JwtStrategy(options, verify) {
    ...
    this._secretCallback = options.secretOrKey;
    if (!this._secretCallback) {
        throw new TypeError('JwtStrategy requires a secret or key');
    }

    if (!isFunction(this._secretCallback)) {
        this._secretCallback = wrapStaticSecretInCallback(this._secretCallback);
    }
